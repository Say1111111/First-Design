...
if(minColors !==null){ 
    ...
    document.Element.style.setProperty('--main-color' , minColors);
...
if(element.dataset.color === localStorage.getItem){
...
let ToggelClass = document.querySelector(".toggel-settings .fa-gear");

ToggelClass.onclick = function(){
